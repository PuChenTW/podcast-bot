...
| `core/database.py` | Async PostgreSQL via asyncpg — see `core/AGENTS.md` |
...
| `web/` | FastAPI web UI: REST API + static frontend for managing subscriptions/episodes — see `web/AGENTS.md` |
