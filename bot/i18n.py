TRANSLATIONS = {
    "en": {
        ...
        "rss_unavailable": "RSS feed is unavailable and no cached episodes found.",
        ...
        "chat_condensing_transcript": "Condensing transcript for AI context…",
    ...
    "zh-tw": {
        ...
        "rss_unavailable": "RSS 來源暫時無法使用，也沒有已快取的集數。",
        ...
        "chat_ended": "對話已結束。",
        "chat_thinking": "思考中…",
        "chat_condensing_transcript": "正在精簡逐字稿以供 AI 使用…",
